...
class AlunoController extends Controller
{
    ...
    public function store(): void
    {
        ...
        $data = $_POST;
        // O número exibido no formulário pode estar desatualizado quando há mais de uma inscrição aberta.
        $data['numero_aluno'] = $this->alunoModel->generateNumeroAluno();
        
        // Converter valores monetários (formato pt-AO: "110,00" -> 110.00)
