<?php
// public/index.php — Front controller para Vercel Docker (FrankenPHP)
...
if (!$matched) {
    ...
    echo '<!DOCTYPE html><html><head><title>404</title></head><body><h1>Página não encontrada</h1></body></html>';
}
